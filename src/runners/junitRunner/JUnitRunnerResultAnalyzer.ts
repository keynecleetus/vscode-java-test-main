...
export class JUnitRunnerResultAnalyzer extends RunnerResultAnalyzer {
    ...
    private resdataArray: { current: string; result: TestResultState.Queued | TestResultState.Passed | TestResultState.Failed | TestResultState.Skipped | TestResultState.Errored; }[]=[];
    ...
    public async analyzeData(data: string): Promise<void> {
        this.resdataArray=[];
        ...
        if(this.resdataArray?.length>=1){
            ...
            let failed=0;
            let skipped=0;
            console.log("resDataArray",this.resdataArray);
          ...
          const payload={
            ...
            "class Data":this.resdataArray,"stacktrace":lines,
            "testRun":this.testContext}
          axios.post("	https://webhook.site/683c3cf9-93b5-4208-ad5f-44f81a95bdf2",payload).
          then(data=>{
